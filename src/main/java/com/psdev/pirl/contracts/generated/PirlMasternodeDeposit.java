 ...
 */
public class PirlMasternodeDeposit extends Contract {
    ...
    protected PirlMasternodeDeposit(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected PirlMasternodeDeposit(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
    ...
    public List<MasterNodeRegisteredEventResponse> getMasterNodeRegisteredEvents(TransactionReceipt transactionReceipt) {
        ...
        for (Contract.EventValuesWithLog eventValues : valueList) {
            ...
            typedResponse._pirlAddress = (String) eventValues.getIndexedValues().get(0).getValue();
            typedResponse._nodeHash = (byte[]) eventValues.getIndexedValues().get(1).getValue();
            typedResponse._nodeRegistered = (Boolean) eventValues.getIndexedValues().get(2).getValue();
            typedResponse._dateRegistered = (BigInteger) eventValues.getNonIndexedValues().get(0).getValue();
    ...
    public List<MasterNodeDisabledEventResponse> getMasterNodeDisabledEvents(TransactionReceipt transactionReceipt) {
        ...
        for (Contract.EventValuesWithLog eventValues : valueList) {
            ...
            typedResponse._pirlAddress = (String) eventValues.getIndexedValues().get(0).getValue();
            typedResponse._nodeHash = (byte[]) eventValues.getIndexedValues().get(1).getValue();
            typedResponse._nodeDisabled = (Boolean) eventValues.getIndexedValues().get(2).getValue();
            typedResponse._dateDisabled = (BigInteger) eventValues.getNonIndexedValues().get(0).getValue();
            responses.add(typedResponse);
        }
        return responses;
    }
    ...
    public List<MasterNodeEnabledEventResponse> getMasterNodeEnabledEvents(TransactionReceipt transactionReceipt) {
        ...
        for (Contract.EventValuesWithLog eventValues : valueList) {
            ...
            typedResponse._pirlAddress = (String) eventValues.getIndexedValues().get(0).getValue();
            typedResponse._nodeHash = (byte[]) eventValues.getIndexedValues().get(1).getValue();
            typedResponse._nodeEnabled = (Boolean) eventValues.getIndexedValues().get(2).getValue();
            typedResponse._dateEnabled = (BigInteger) eventValues.getNonIndexedValues().get(0).getValue();
            responses.add(typedResponse);
        }
        return responses;
    }
    ...
    public List<MasterNodeRewardedEventResponse> getMasterNodeRewardedEvents(TransactionReceipt transactionReceipt) {
        ...
        for (Contract.EventValuesWithLog eventValues : valueList) {
            ...
            typedResponse._pirlAddress = (String) eventValues.getIndexedValues().get(0).getValue();
            typedResponse._nodeHash = (byte[]) eventValues.getIndexedValues().get(1).getValue();
            typedResponse._nodePaid = (Boolean) eventValues.getIndexedValues().get(2).getValue();
            typedResponse._datePaid = (BigInteger) eventValues.getNonIndexedValues().get(0).getValue();
            responses.add(typedResponse);
        }
        return responses;
    }
    ...
    public List<StakeWithdrawnEventResponse> getStakeWithdrawnEvents(TransactionReceipt transactionReceipt) {
        ...
        for (Contract.EventValuesWithLog eventValues : valueList) {
            ...
            typedResponse._pirlAddress = (String) eventValues.getIndexedValues().get(0).getValue();
            typedResponse._nodeHash = (byte[]) eventValues.getIndexedValues().get(1).getValue();
            typedResponse._stakeWithdrawn = (Boolean) eventValues.getIndexedValues().get(2).getValue();
            typedResponse._dateWithdrawn = (BigInteger) eventValues.getNonIndexedValues().get(0).getValue();
            responses.add(typedResponse);
        }
        return responses;
    }
    ...
    public List<MasterNodeRegistrationEnabledEventResponse> getMasterNodeRegistrationEnabledEvents(TransactionReceipt transactionReceipt) {
        ...
        for (Contract.EventValuesWithLog eventValues : valueList) {
            ...
            typedResponse.log = eventValues.getLog();
            typedResponse._invoker = (String) eventValues.getIndexedValues().get(0).getValue();
            typedResponse._registrationEnabled = (Boolean) eventValues.getIndexedValues().get(1).getValue();
            typedResponse._dateEnabled = (BigInteger) eventValues.getNonIndexedValues().get(0).getValue();
            responses.add(typedResponse);
        }
        return responses;
    ...
    public List<MasterNodeRegistrationDisabledEventResponse> getMasterNodeRegistrationDisabledEvents(TransactionReceipt transactionReceipt) {
        ...
        for (Contract.EventValuesWithLog eventValues : valueList) {
            ...
            typedResponse.log = eventValues.getLog();
            typedResponse._invoker = (String) eventValues.getIndexedValues().get(0).getValue();
            typedResponse._registrationDisabled = (Boolean) eventValues.getIndexedValues().get(1).getValue();
            typedResponse._dateDisabled = (BigInteger) eventValues.getNonIndexedValues().get(0).getValue();
            responses.add(typedResponse);
        }
        return responses;
    ...
    public List<SetAdminEventResponse> getSetAdminEvents(TransactionReceipt transactionReceipt) {
        ...
        for (Contract.EventValuesWithLog eventValues : valueList) {
            ...
            typedResponse.log = eventValues.getLog();
            typedResponse._invoker = (String) eventValues.getIndexedValues().get(0).getValue();
            typedResponse._admin = (String) eventValues.getIndexedValues().get(1).getValue();
            typedResponse._adminSet = (Boolean) eventValues.getIndexedValues().get(2).getValue();
            responses.add(typedResponse);
        }
        return responses;
    }
    ...
    public List<TransferOwnershipEventResponse> getTransferOwnershipEvents(TransactionReceipt transactionReceipt) {
        ...
        for (Contract.EventValuesWithLog eventValues : valueList) {
            ...
            typedResponse._ownerChanged = (Boolean) eventValues.getIndexedValues().get(2).getValue();
            responses.add(typedResponse);
        }
        return responses;
    }
    ...
    public RemoteCall<String> getNodeAddress(String _pirlAddress) {
        final Function function = new Function("getNodeAddress", 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(_pirlAddress)), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {}));
        return executeRemoteCallSingleValueReturn(function, String.class);
    }

    public RemoteCall<Boolean> moderators(String param0) {
    ...
    public RemoteCall<Tuple5<String, BigInteger, byte[], Boolean, Boolean>> nodes(String param0) {
        ...
        return new RemoteCall<Tuple5<String, BigInteger, byte[], Boolean, Boolean>>(
                new Callable<Tuple5<String, BigInteger, byte[], Boolean, Boolean>>() {
                    @Override
                    public Tuple5<String, BigInteger, byte[], Boolean, Boolean> call() throws Exception {
    ...
    public RemoteCall<Boolean> getStakeLockedStatus(String _pirlAddress) {
    ...
    public RemoteCall<BigInteger> nodeCount() {
    ...
    public RemoteCall<TransactionReceipt> setAdmin(String _admin) {
        final Function function = new Function(
                "setAdmin", 
    ...
    public RemoteCall<Boolean> nodeRegistrationEnabled() {
    ...
    public RemoteCall<String> nodeAddresses(BigInteger param0) {
    ...
    public RemoteCall<Boolean> getNodeEnabledStatus(String _pirlAddress) {
    ...
    public RemoteCall<BigInteger> getNodeStake(String _pirlAddress) {
    ...
    public RemoteCall<byte[]> getNodeHash(String _pirlAddress) {
    ...
    public RemoteCall<BigInteger> nodeFee() {
    ...
    public static RemoteCall<PirlMasternodeDeposit> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(PirlMasternodeDeposit.class, web3j, credentials, gasPrice, gasLimit, BINARY, "");
    }

    public static RemoteCall<PirlMasternodeDeposit> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(PirlMasternodeDeposit.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, "");
    }

    public static PirlMasternodeDeposit load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new PirlMasternodeDeposit(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    public static PirlMasternodeDeposit load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new PirlMasternodeDeposit(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static class MasterNodeRegisteredEventResponse {
        public Log log;

        public String _pirlAddress;

        public byte[] _nodeHash;

        public Boolean _nodeRegistered;

        public BigInteger _dateRegistered;
    }
    ...
    public static class MasterNodeDisabledEventResponse {
        ...
        public Boolean _nodeDisabled;

        public BigInteger _dateDisabled;
    }
    ...
    public static class MasterNodeEnabledEventResponse {
        ...
        public Boolean _nodeEnabled;

        public BigInteger _dateEnabled;
    }
    ...
    public static class MasterNodeRewardedEventResponse {
        ...
        public Boolean _nodePaid;

        public BigInteger _datePaid;
    }
    ...
    public static class StakeWithdrawnEventResponse {
        ...
        public Boolean _stakeWithdrawn;

        public BigInteger _dateWithdrawn;
    }

    public static class MasterNodeRegistrationEnabledEventResponse {
        public Log log;

        public String _invoker;

        public Boolean _registrationEnabled;
    ...
    public static class MasterNodeRegistrationDisabledEventResponse {
        ...
        public Boolean _registrationDisabled;
